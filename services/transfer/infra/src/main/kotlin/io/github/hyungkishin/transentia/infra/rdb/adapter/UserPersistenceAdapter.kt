...
class UserPersistenceAdapter(
    ...
    override fun findByAccountNumberWithLock(accountNumber: String): User? {
        ...
        val userId = jpaRepository.findUserIdByAccountNumberForUpdate(accountNumber)
            ?: return null
     ...
     */
    private fun syncUserEntity(entity: UserJpaEntity, domain: User) {
        // AccountBalance 동기화 (잔액 변경)
        val existingAccountEntity = entityManager.find(
