...
class FraudPatternStreamProcessor(
        ...
        Function { input ->
            input
                ...
                .filter { accountId, stats ->
                    val isSuspicious =
                        stats.count >= SUSPICIOUS_TRANSFER_COUNT ||
    ...
    private fun Long.formatAmount(): String = String.format("%,d", this)
}
...
class AccountTransferStatsSerde(
    ...
    override fun serializer() =
        org.apache.kafka.common.serialization.Serializer<AccountTransferStats> { _, data ->
            objectMapper.writeValueAsBytes(data)
        }

    override fun deserializer() =
        org.apache.kafka.common.serialization.Deserializer<AccountTransferStats> { _, data ->
